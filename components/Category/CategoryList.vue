...
const headers = ref([
  ...
  { title: "ຊື່ໝວດໝູ່", key: "name", sortable: false },
  { title: "ໝວດໝູ່ແມ່", key: "parent_id", sortable: false },
  { title: "ລຳດັບສະແດງ", key: "sort_order", sortable: false },
  ...
  <div class="pa-6">
    <v-card elevation="0" tile width="100%" min-height="95vh" class="pa-6">
      <v-row>
        <v-col cols="12">
          <GlobalTextTitleLine
            :title="`ຈັດການໝວດໝູ່ສິນຄ້າ / Manage Category (${formatNumber(
        ...
        >
          ...
          <div v-if="permission.can_create" class="d-flex flex-wrap align-center">
            <v-btn color="primary" elevation="0" @click="goPath('/category/create')">
